...
import { createInterviewTask } from './src/tools/createTask.js';
import { analyzeTaskPhase1, analyzeTaskPhase2, saveAnalysisResult } from './src/tools/analyzeTask.js';
import { startInterview } from './src/tools/startInterview.js';
import { getTaskStatus } from './src/tools/getStatus.js';
import { answerQuestion, addFollowUpQuestion } from './src/tools/answerQuestion.js';
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            analysisResult: {
              type: 'object',
              description: '分析结果JSON对象，包含4轮面试的问题'
            }
          },
...
async function main() {
  ...
  console.error('Femock JS MCP server running on stdio');
}
